...
export function useCheckUser(args: { operation: PolicyCrudKind; where?: { id?: string; email?: string; password?: string; name?: string; avatarUrl?: string; supabaseUid?: string; companyId?: string }; }, options?: QueryOptions<boolean>) {
